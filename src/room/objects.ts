...
export const ROOM_OBJECTS: RoomObjectDef[] = [
  ...
  { id: 'cushion', source: require('../assets/room/cushion.png'), kind: 'flat', x: 0.52, y: 0.76, w: 0.15, shop: { name: '바닥 쿠션', price: 20 } },
  ...
  { id: 'wardrobe', source: require('../assets/room/wardrobe.png'), kind: 'solid', x: 0.64, y: 0.41, w: 0.21, footDepth: 0.03, shop: { name: '옷장', price: 50 } },
  { id: 'bookshelf', source: require('../assets/room/bookshelf.png'), kind: 'solid', x: 0.865, y: 0.41, w: 0.2, footDepth: 0.03, shop: { name: '책장', price: 40 } },

  // out in the room
  { id: 'desk_set', source: require('../assets/room/desk_set.png'), kind: 'solid', x: 0.8, y: 0.72, w: 0.28, footDepth: 0.04, shop: { name: '책상 세트', price: 60 } },
  { id: 'basket', source: require('../assets/room/basket.png'), kind: 'solid', x: 0.13, y: 0.68, w: 0.17, footDepth: 0.03, shop: { name: '바구니', price: 20 } },
  { id: 'book_stack', source: require('../assets/room/book_stack.png'), kind: 'solid', x: 0.29, y: 0.6, w: 0.09, footDepth: 0.025, shop: { name: '책 더미', price: 20 } },
  { id: 'teddy_bear', source: require('../assets/room/teddy_bear.png'), kind: 'solid', x: 0.4, y: 0.64, w: 0.13, footDepth: 0.03, footWidth: 0.7, shop: { name: '곰인형', price: 30 } },
  { id: 'plant', source: require('../assets/room/plant.png'), kind: 'solid', x: 0.09, y: 0.93, w: 0.17, footDepth: 0.035, footWidth: 0.6, shop: { name: '화분', price: 20 } },
  { id: 'standing_lamp', source: require('../assets/room/standing_lamp.png'), kind: 'solid', x: 0.95, y: 0.94, w: 0.09, footDepth: 0.02, footWidth: 0.5, shop: { name: '스탠드 조명', price: 30 } },
];
